...
write(seqs_fasta, file = "barlow_asvs.fasta")
```
...
/programs/mafft/bin/mafft --auto --quiet barlow_asvs.fasta > aligned_asvs.fasta 
...
root_physeq <- merge_phyloseq(clean_barlow_phylo, root_tree)
...
```{r save-tree}
save(root_physeq, file = "root_physeq.RData")
```
