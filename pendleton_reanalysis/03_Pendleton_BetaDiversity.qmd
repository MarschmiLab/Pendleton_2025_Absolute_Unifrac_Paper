...
abs_tables <- generate_rarefied_abs_tables(physeq = full_diversity_physeq, # Physeq with non-normalized counts (do not convert to rel abundance!)
...
rel_tables <- generate_rarefied_abs_tables(physeq = full_diversity_physeq, # Physeq with non-normalized counts (do not convert to rel abundance!)
                              iterations = 100, # Number of rarefy steps
                              rare.depth = min(sample_sums(full_diversity_physeq)), # Depth to rarefy to
